...
public class Date {
	 ...
	 * Asigna los parametros que recibe a los atributos de la clase Date.
	 * No se admiten fechas tales como 99/15/xxxx, entonces hay que plantear unas condiciones que no permitan que esas fechas funcionen y se lance una extepción.
	 * @param day
	 *            Día de mi fecha
	 * @param month
	 *            Mes de mi fecha
...
//MÉTODOS TRANSPARENCIA 1:
	...
	/**
	 * Método que recibe otra fecha que se le pasa como parámetro y compara su año con el de los atributos de la clase, es decir con el de mi fecha. Si son iguales devuelve true, si no, false.
	 * 
	 * @param fecha2
	 *            La otra fecha que queremos comparar
	 */
	...
	/**
	 * Método que recibe otra fecha que se le pasa como parámetro y compara su mes con el de los atributos de la clase, es decir con el de mi fecha. Si son iguales devuelve true, si no, false.
	 * 
	 * @param fecha2
	 *            La otra fecha que queremos comparar
	 */
	...
	/**
	 * Método que recibe otra fecha que se le pasa como parámetro y compara su día con el de los atributos de la clase, es decir con el de mi fecha. Si son iguales devuelve true, si no, false.
	 * 
	 * @param fecha2
	 *            La otra fecha que queremos comparar
	 */
	...
	/**
	 * Método que recibe otra fecha que se le pasa como parámetro y la compara (entera) con mi fecha. Si son iguales devuelve true, si no, false.
	 * 
	 * @param fecha2
	 *            La otra fecha que queremos comparar
	 */
	...
	/**
	 * Método que recibe otra fecha que se le pasa como parámetro y compara su año con el de los atributos de la clase, es decir con el de mi fecha. 
	 * Sin usar if, directamente devolverá un true si se cumple lo que está en el return y si no, un false, porque en la firma del método ya hemos dicho que devolverá un boolean.
	 * 
	 * @param fecha2
	 *            La otra fecha que queremos comparar
	 */
	...
	/**
	 * Método que recibe otra fecha que se le pasa como parámetro y compara su mes con el de los atributos de la clase, es decir con el de mi fecha. 
	 * Sin usar if, directamente devolverá un true si se cumple lo que está en el return y si no, un false, porque en la firma del método ya hemos dicho que devolverá un boolean.
	 * 
	 * @param fecha2
	 *            La otra fecha que queremos comparar
	...
	/**
	 * Método que recibe otra fecha que se le pasa como parámetro y compara su día con el de los atributos de la clase, es decir con el de mi fecha. 
	 * Sin usar if, directamente devolverá un true si se cumple lo que está en el return y si no, un false, porque en la firma del método ya hemos dicho que devolverá un boolean.
	 * 
	 * @param fecha2
	 *            La otra fecha que queremos comparar
	...
	/**
	 * Método que recibe otra fecha que se le pasa como parámetro y compara su fecha completa con mi fecha.
	 * Sin usar if, directamente devolverá un true si se cumple lo que está en el return y si no, un false, porque en la firma del método ya hemos dicho que devolverá un boolean.
	 * 
	 * @param fecha2
	 *            La otra fecha que queremos comparar
...
//MÉTODOS DE LA TRANSPARENCIA 2:
	...
	/**
	 * Método que devuelve el nombre del mes de mi fecha.
	 ...
	 * @param mes
	 *           mes genérico
	 * Le paso como parámetro un mes genérico porque si no le pongo nada solo podría obtener el ultimo dia del mes de mi fecha.
	 * siendo así ese "int mes" generico tomará un valor u otro según que fecha lo llame.         
	 */
	...
	/**
	 * Método que valida si el dia del mes de mi fecha es correcto  (por ejemplo, que el 30 de febrero no valga).
	 * Lo creo con if else.
	 * Si no, bastaría con poner la condición "this.day <= this.ultimoDiaMes(this.month) && this.day >= 1" detrás del return como hago en los metodos de la transparencia 1 sin if.
	 * 
	 * No se le pasa nada como parámetros puesto que solo usa los atributos de la clase.	  
	 * 
	 */
	...
	/**
	 * Método que devuelve la estación correspondiente al mes de la fecha.
...
//MÉTODOS DE LA TRANSPARENCIA 3:
	...
	/**
	 * Método que devuelve el nombre de los meses restantes desde el intoducido (no se incluye) hasta el final del año.
	 * 
	 * 	  
	 * No se le pasa nada como parámetros puesto que solo usa los atributos de la clase.	
	 */
	...
	/**
	 * Método que genera todas las fechas desde la fecha establecida hasta la ultima fecha del mes.
	 * Para ello, se vale del método auxiliar que hemos creado y que nos dice el ultimo dia del mes, y del método que convierte la fecha en cadena de texto y la muestra por pantalla.
	 * 
	 * 	  
	 * No se le pasa nada como parámetros puesto que solo usa los atributos de la clase.	
	 */
	...
	/**
	 * Método que imprime los meses con el mismo numero de dias que el mes de mi fecha.
	...
	/**
	 * Método que imprime el número de días que hay desde el 1 de Enero hasta mi fecha.
	 * Recorre todos los meses a ver cuales tienen los mismos dias que el de mi fecha, y los imprime.
	 *
	 * 	  
	 * No se le pasa nada como parámetros puesto que solo usa los atributos de la clase.	
...
//MÉTODOS TRANSPARENCIA 4:
	...
	/**
	 * Método que imprime el número de intentos necesarios para generar una fecha aleatoria que coincida con mi fecha.
	 * Se utiliza el while.
	 * 	  
	 * No se le pasa nada como parámetros puesto que solo usa los atributos de la clase.	
	 */
...
//con el do while entra directamente a generar numeros aleatorios sin chequear la condicion entonces no me hace falta plantear el caso inicial de 0 para el mes y dia.
	...
	/**
	 * Método auxiliar para el ultimo método que me dice a qué día de la semana se corresponde ese resto de la division modulo 7.
	 * 
	 * 
	 * 	  
	 * @param i
	 *           Un entero entre 0 y 6 (el resto de la division módulo 7)
	 */ 
